        ...
        <div className="flex flex-col my-16">
            <div className="grid grid-cols-12">
                <div className="col-span-12 md:col-span-6 flex justify-center">
                    {
                        loading ?
                        <Skeleton className="max-h-[400px] max-w-[400px] object-contain flex justify-center items-center w-full px-52 h-full overflow-hidden border-[1px] border-gray-200" /> :
                ...
                <div className="col-span-12 md:col-span-6 p-5">
                    {
                        ...
                        (product.discount ? product.discount.type === "percentage" ? <p className='inline-block bg-blue-700 text-white p-2 my-2 text-sm'>-{product.discount.value}%</p> : null
                         : null)
                    }
                    {
                        loading ?
                    ...
                    {
                        loading ?
                        <Skeleton count={1} height={40} className="my-5" /> :
    ...
    return (
        <div className="w-full container mx-auto">
            <div className="flex justify-center">
                <button className={selectedTab === 'desc' ? "bg-gray-50 text-blue-700 px-10 py-5 border-b-2 border-blue-700  hover:bg-gray-200 duration-300" : "bg-transparent text-black px-10 py-5 border-b-2 border-gray-400  hover:bg-gray-200 duration-300"} onClick={() => setSelectedTab('desc')}>Description</button>
                <button className={selectedTab === 'reviews' ? "bg-gray-50 text-blue-700 px-10 py-5 border-b-2 border-blue-700  hover:bg-gray-200 duration-300" : "bg-transparent text-black px-10 py-5 border-b-2 border-gray-400  hover:bg-gray-200 duration-300"} onClick={() => setSelectedTab('reviews')}>Reviews</button>
            </div>
            <div className="bg-gray-50 w-full px-3 md:px-5 py-10">
                {
                    selectedTab === 'desc' ? 
                    <DescriptionTab /> : 
                    <p>Reviews</p>
