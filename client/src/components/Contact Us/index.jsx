...
const ContactUs = () => {
    return (
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <form action="" className="bg-gradient-to-tr from-blue-700 to-blue-900 p-10">
                <div className="flex flex-col my-5">
                    <label htmlFor="fullname" className="text-white mb-2">Your Name</label>
                    <input type="text" id="fullname" className="w-full bg-white border-none outline-none p-3" />
                </div>
                <div className="flex flex-col my-5">
                    <label htmlFor="email" className="text-white mb-2">Your Email</label>
                    <input type="text" id="email" className="w-full bg-white border-none outline-none p-3" />
                </div>
                <div className="flex flex-col my-5">
                    <label htmlFor="subject" className="text-white mb-2">Subject</label>
                    <input type="text" id="subject" className="w-full bg-white border-none outline-none p-3" />
                </div>
                <div className="flex flex-col my-5">
                    <label htmlFor="message" className="text-white mb-2">Your Message</label>
                    <textarea type="text" id="message" className="w-full bg-white border-none outline-none p-3 resize-none" rows={5}></textarea>
                </div>
                <button type="submit" className="border-[1px] border-white hover:text-blue-700 px-10 py-3 text-white shop-now-btn overflow-hidden relative duration-300">Submit</button>
            </form>
        </div>
        </>
    );
