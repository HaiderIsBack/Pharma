    ...
    <div className="relative text-white bg-gradient-to-tr from-blue-700 to-blue-900 p-5">
        ...
        <div className="absolute -bottom-0 left-0 translate-y-1/2 w-full px-5">
            <div className="relative w-full">
                <Swiper slidesPerView={ window.innerWidth < 1024 ? 2 : 5} spaceBetween={20} loop={false} className='pb-32 mt-44'>
                    <SwiperSlide className='cursor-grab active:cursor-grabbing'>
                        <div className="rounded-t-md rounded-b-3xl bg-gradient-to-tr from-gray-100 to-blue-300 shadow-lg flex-col items-center justify-center relative pt-3 pb-16 md:pb-32">
                            <h5 className='text-blue-700 text-sm md:text-md md:text-md text-center font-bold uppercase'>Pain Killers</h5>
                            <center>
                                <img src="/panadol-product.png" alt="" className='h-[75px] md:h-[150px] absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/3 drop-shadow-2xl hover:scale-90 cursor-pointer duration-300' loading='lazy' />
                            </center>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='cursor-grab active:cursor-grabbing'>
                        <div className="rounded-t-md rounded-b-3xl bg-gradient-to-tr from-gray-100 to-blue-300 shadow-lg flex-col items-center justify-center relative pt-3 pb-16 md:pb-32">
                            ...
                            <center>
                                <img src="/head-and-shoulders.png" alt="" className='h-[75px] md:h-[150px] absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/3 drop-shadow-2xl hover:scale-90 cursor-pointer duration-300' loading='lazy' />
                            </center>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='cursor-grab active:cursor-grabbing'>
                        <div className="rounded-t-md rounded-b-3xl bg-gradient-to-tr from-gray-100 to-red-300 shadow-lg flex-col items-center justify-center relative pt-3 pb-16 md:pb-32">
                            ...
                            <center>
                                <img src="/ponds-lotion.png" alt="" className='h-[75px] md:h-[150px] absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/3 drop-shadow-2xl hover:scale-90 cursor-pointer duration-300' loading='lazy' />
                            </center>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='cursor-grab active:cursor-grabbing'>
                        <div className="rounded-t-md rounded-b-3xl bg-gradient-to-tr from-gray-100 to-blue-300 shadow-lg flex-col items-center justify-center relative pt-3 pb-16 md:pb-32">
                            ...
                            <center>
                                <img src="/nangrow-milk.png" alt="" className='h-[75px] md:h-[150px] absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/3 drop-shadow-2xl hover:scale-90 cursor-pointer duration-300' loading='lazy' />
                            </center>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='cursor-grab active:cursor-grabbing'>
                        <div className="rounded-t-md rounded-b-3xl bg-gradient-to-tr from-gray-100 to-amber-600 shadow-lg flex-col items-center justify-center relative pt-3 pb-16 md:pb-32">
                            ...
                            <center>
                                <img src="/nescafe-coffee.png" alt="" className='h-[75px] md:h-[150px] absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/3 drop-shadow-2xl hover:scale-90 cursor-pointer duration-300' loading='lazy' />
                            </center>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='cursor-grab active:cursor-grabbing'>
